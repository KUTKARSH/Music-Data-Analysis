...
VALIDDIR=/home/cloudera/utkarsh/project/processed_dir/valid/batch_$batchid
INVALIDDIR=/home/cloudera/utkarsh/project/processed_dir/invalid/batch_$batchid

echo "Running hive script for data enrichment and filtering..." >> $LOGFILE

hive -hiveconf batchid=$batchid -f /home/cloudera/utkarsh/project/scripts/data_enrichment.hql
...
find /home/cloudera/utkarsh/project/processed_dir/ -mtime +7 -exec rmdir {} \;
